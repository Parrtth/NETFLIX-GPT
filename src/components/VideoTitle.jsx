...
const VideoTitle = ({title, overview}) => {
  return (
    <div className='absolute inset-0 z-20 flex flex-col justify-end px-4 sm:px-8 md:px-16 lg:px-24 pb-6 sm:pb-8 md:pb-12 lg:pb-16'>
        ...
        {/* Overview */}
        <p className='text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-3xl leading-relaxed drop-shadow-lg'>
            {overview}
        </p>
