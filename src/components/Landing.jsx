    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <footer className="py-12 px-4 md:px-8 border-t border-white/10 text-gray-500">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-8">
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>FAQ</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Help Centre</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Account</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Media Centre</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Investor Relations</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Jobs</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Ways to Watch</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Terms of Use</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Privacy</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Cookie Preferences</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Corporate Information</a>
          <a href="#" className="hover:underline cursor-pointer" onClick={(e) => e.preventDefault()}>Contact Us</a>
        </div>
